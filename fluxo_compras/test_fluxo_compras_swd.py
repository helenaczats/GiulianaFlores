...
class TestFluxocompras():
  ...
  def test_loginPositivo(self):
    ...
    self.driver.find_element(By.ID, "ContentSite_txtZip").send_keys("2024.04.20")
    ...
    self.driver.find_element(By.ID, "txtPhone").click() #telefone do destinatário
    self.driver.find_element(By.ID, "txtPhone").send_keys("(11) 99998-7655")
